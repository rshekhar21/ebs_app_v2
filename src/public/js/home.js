...
import { jq, log, doc, formDataToJson, getData, create } from './help.js';
...
const list = [
    { key: 'closing', name: 'Closing', url: `${urlstr}closing`, icon: 'checklist', bsicon:closeIcon, img: '', hidden: false },
    { key: 'sales', name: 'Sales', url: `${urlstr}sales`, icon: 'list_alt', bsicon:salesIcon, img: '', hidden: false },
    { key: 'orders', name: 'Orders', url: `${urlstr}orders`, icon: 'orders', bsicon:'<i class="bi bi-list-ol"></i>', img: '', },
    { key: 'neworder', name: 'New Order', url: `${urlstr}orders/create`, icon: 'orders', bsicon:'<i class="bi bi-receipt"></i>', img: '', hidden: false },
    { key: 'party', name: 'Partys', url: `${urlstr}partys`, icon: 'group', bsicon:'<i class="bi bi-people"></i>', img: '', hidden: false },
    { key: 'dues', name: 'Party Dues', url: `${urlstr}dues`, icon: 'contact_page', bsicon:'<i class="bi bi-plus-slash-minus"></i>', img: '', hidden: false },
    { key: 'stock', name: 'Stock', url: `${urlstr}stock`, icon: 'inventory', bsicon:stockIcon, img: '', hidden: false },
    { key: 'purchase', name: 'Purchase', url: `${urlstr}purch`, icon: 'shopping_cart', bsicon:'<i class="bi bi-bag-check"></i>', img: '', hidden: false },
    { key: 'supplier', name: 'Suppliers', url: `${urlstr}supplier`, icon: 'shopping_cart', bsicon:supIcon, img: '', hidden: false },
    { key: 'payments', name: 'Payments', url: `${urlstr}pymts`, icon: 'currency_rupee', bsicon:'<i class="bi bi-currency-rupee"></i>', img: '', hidden: false },
    { key: 'sold', name: 'Sold', url: `${urlstr}sold`, icon: 'filter_list', bsicon:'<i class="bi bi-arrow-return-right"></i>', img: '', hidden: false },
    { key: 'gr', name: 'GR', url: `${urlstr}gr`, icon: 'filter_list', bsicon:'<i class="bi bi-arrow-return-left"></i>', img: '', hidden: false },
    { key: 'notes', name: 'Notes', url: `${urlstr}notes`, icon: 'notes', bsicon:'<i class="bi bi-card-text"></i>', img: '', hidden: false },
    { key: 'expense', name: 'Expenses', url: `${urlstr}expense`, icon: 'request_quote', bsicon:'<i class="bi bi-wallet2"></i>', img: '', hidden: false },
    { key: 'employee', name: 'Employees', url: `${urlstr}emp`, icon: 'person_apron', bsicon:'<i class="bi bi-person"></i>', img: '', hidden: false },
    { key: 'banks', name: 'Banks', url: `${urlstr}banks`, icon: 'account_balance', bsicon:'<i class="bi bi-bank"></i>', img: '', hidden: false },
    { key: 'users', name: 'Users', url: `${urlstr}users`, icon: '', bsicon:'<i class="bi bi-person-check"></i>', img: '', hidden: false },
    { key: 'entity', name: 'Entity', url: `${urlstr}entity`, icon: '', bsicon:'<i class="bi bi-brightness-low"></i>', img: '', hidden: false },
    // { key: 'settings', name: 'Settings', url: `${urlstr}settings`, icon: '', bsicon:'<i class="bi bi-gear"></i>', img: '', hidden: false },
    { key: 'switch', name: 'Switch App', url: '/apps', icon: 'toggle_on', bsicon:'<i class="bi bi-toggle-off"></i>', img: '', hidden: false },
    { key: 'logout', name: 'Logout', url: '/logout', icon: 'logout', bsicon:'<i class="bi bi-box-arrow-right"></i>', img: '', hidden: false },
]
