...
const update = {
  ...
  [s.party]: [`reg_date`, `party_type`, `title`, `party_name`, `contact`, `email`, `company`, `gender`, `aadhaar`, `pan_num`, `gst_number`, `birthday`, `address`, `city`, `state`, `state_code`, `rewards`, `enable_rewards`, `pincode`, `opening_bal`, `opening_cr`, `id`],
  [s.address]: [`type`, `address`, `htmladdress`, `city`, `pincode`, `state`, `state_code`, `country`, `lmark`, `notes`, `id`],
  [s.stock]: ['ean', `hsn`, `upc`, `pcode`, `product`, `mrp`, `price`, `wsp`, `gst`, `purch_price`, `cost`, `cost_gst`, `cost_tax`, `unit`, `size`, `qty`, `type`, `discount`, `disc_type`, `colour`, `season`, `section`, `category`, `label`, `tag`, `brand`, `comments`, `id`],
...
const create = {
  ...
  [s.stock]: [`sku`, `ean`, `hsn`, `upc`, `pcode`, `product`, `mrp`, `price`, `wsp`, `gst`, `purch_price`, `cost`, `cost_gst`, `cost_tax`, `unit`, `size`, `qty`, `type`, `discount`, `disc_type`, `colour`, `season`, `section`, `category`, `label`, `tag`, `brand`, `comments`, `purch_id`, `user_id`, `temp_id`],
